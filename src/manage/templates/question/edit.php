...
<div class="right-layout">
    ...
    <div class="main-screen">
        <div class="main-content">
            <form name="add_respondent" action="/manage/survey/<?=escHtmlAttr($surveyId)?>/questions/edit/<?=escHtmlAttr($question->id)?>/" method="POST">
                    ...
                    <div class="panel-content">
                        ...
                        <div class="material field">
                            <div class="control">
                                <input type="text" name="title" id="title" class="input"
                                    placeholder="Pertanyaan" value="<?=(isset($question->title) ? $question->title : '')?>" autocomplete="off" required>
                                <hr>
                            ...
                            <div class="control">
                                <select name="question_type_id" id="question_type_id" class="input select is-filled" required="">
                                    <?php foreach ($questionTypes as $questionType) : ?>
                                        <option value="<?=escHtmlAttr($questionType->id)?>" <?=(isset($question->question_type_id) && $questionType->id == $question->question_type_id ? 'selected' : '')?>>
                        ...
                        <div class="material field add-choice-field">
                            ...
                            <label for="allow_add" class="label checkbox-label">
                                ...
                                <input type="checkbox" name="allow_add" id="allow_add" value="1" class="checkbox" <?=(isset($question->allow_add) && $question->allow_add ? 'checked' : '')?>>
                        ...
                        <div class="repeater-fields choice-fields">
                            <?php if (isset($questionChoices)) : ?>
                                <?php foreach ($questionChoices as $questionChoice) : ?>
                                    ...
                                    <div class="control">
                                        <input type="text" name="question_choice_<?=$questionChoice->id?>" id="question_choice_<?=$questionChoice->id?>" class="input"
                                            placeholder="Masukkan Pilihan" value="<?=escHtml($questionChoice->title)?>" autocomplete="off" required>
                                        <hr>
                                        <label for="question_choice_<?=$questionChoice->id?>">Pilihan</label>
                                    </div>
