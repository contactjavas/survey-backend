...
<div class="right-layout">
    ...
    <div class="main-screen">
        <div class="main-content">
            <form name="add_vote" action="/manage/survey/<?=escHtmlAttr($surveyId)?>/votes/add/" method="POST">
                            ...
                            <div class="panel">
                                ...
                                <div class="panel-content">
                                            ...
                                            <?php if ($allow_multiple) : ?>
                                                <div class="material field">
                                                    <label for="question_choices_<?=escHtmlAttr($question->id)?>[]_<?=$choiceIndex?>" class="label checkbox-label">
                                                        ...
                                                        <input type="checkbox" name="question_choices_<?=escHtmlAttr($question->id)?>[]" id="question_choices_<?=escHtmlAttr($question->id)?>[]_<?=$choiceIndex?>" value="<?=escHtmlAttr($choice->id)?>" class="checkbox">
                                            ...
                                            <?php else : ?>
                                                <div class="material field">
                                                    <label for="question_choice_<?=escHtmlAttr($question->id)?>_<?=$choiceIndex?>" class="label radio-label">
                                                        <?=escHtmlAttr($choice->title)?>
                                                        <input type="radio" name="question_choice_<?=escHtmlAttr($question->id)?>" id="question_choice_<?=escHtmlAttr($question->id)?>_<?=$choiceIndex?>" value="<?=escHtmlAttr($choice->id)?>" class="radio">
                                                        <div class="indicator"></div>
                                                    </label>
                                                </div>
                                            <?php endif; ?>
                                    ...
                                    <?php else : ?>
                                        <div class="material field">
                                            <div class="control">
                                                <textarea name="question_answer_<?=escHtmlAttr($question->id)?>" id="question_answer_<?=escHtmlAttr($question->id)?>" class="input textarea" placeholder="Masukkan Jawaban" autocomplete="off" required><?=(isset($fields['question_answer_<?=escHtmlAttr($question->id)?>']) ? $fields['question_answer_<?=escHtmlAttr($question->id)?>'] : '')?></textarea>
                                                <hr>
