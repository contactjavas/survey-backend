                                    ...
                                    <div class="field">
                                        <div class="control">
                                            <input type="text" name="rt" id="rt"
                                                class="input" placeholder="RT" value="<?=(isset($fields['rt']) ? $fields['rt'] : '')?>"
                                                autocomplete="off" required>
                                            <hr>
                                    ...
                                    <div class="field">
                                        <div class="control">
                                            <input type="text" name="rw" id="rw"
                                                class="input" placeholder="RW" value="<?=(isset($fields['rw']) ? $fields['rw'] : '')?>"
                                                autocomplete="off" required>
                                            <hr>
                                    ...
                                    <div class="control">
                                        <select name="province_id" id="province_id" class="input select is-filled" required="">
                                            <?php foreach ($provinces as $province) : ?>
                                                <option value="<?=escHtmlAttr($province->id)?>" <?=(isset($fields['province_id']) && $province->id == $fields['province_id'] ? 'selected' : '')?>>
                                    ...
                                    <div class="control">
                                        <select name="regency_id" id="regency_id" class="input select is-filled" required="">
                                            <?php foreach ($regencies as $regency) : ?>
                                                <option value="<?=escHtmlAttr($regency->id)?>" <?=(isset($fields['regency_id']) && $regency->id == $fields['regency_id'] ? 'selected' : '')?>>
                                    ...
                                    <div class="control">
                                        <select name="district_id" id="district_id" class="input select is-filled" required="">
                                            <?php foreach ($districts as $district) : ?>
                                                <option value="<?=escHtmlAttr($district->id)?>" <?=(isset($fields['district_id']) && $district->id == $fields['district_id'] ? 'selected' : '')?>>
                                    ...
                                    <div class="control">
                                        <select name="village_id" id="village_id" class="input select is-filled" required="">
                                            <?php foreach ($villages as $village) : ?>
                                                <option value="<?=escHtmlAttr($village->id)?>" <?=(isset($fields['village_id']) && $village->id == $fields['village_id'] ? 'selected' : '')?>>
