...
<div class="right-layout">
    ...
    <div class="main-screen">
        <div class="main-content">
            <form name="add_respondent" action="/manage/survey/<?=escHtmlAttr($surveyId)?>/candidates/add/" method="POST">
                        ...
                        <div class="material field">
                            <div class="control">
                                <input type="text" name="name" id="name" class="input"
                                    placeholder="Nama Calon" value="<?=(isset($fields['name']) ? $fields['name'] : '')?>" autocomplete="off" required>
                                <hr>
                            ...
                            <div class="control">
                                <select name="candidate_type_id" id="candidate_type_id" class="input select is-filled" required="">
                                    <?php foreach ($candidateTypes as $candidateType) : ?>
                                        <option value="<?=escHtmlAttr($candidateType->id)?>" <?=(isset($fields['candidate_type_id']) && $candidateType->id == $fields['candidate_type_id'] ? 'selected' : '')?>>
