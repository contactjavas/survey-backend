                        ...
                        <div class="table">
                            ...
                            <div class="tbody">
                                <?php foreach ($candidates as $candidate) : ?>
                                    <div class="row">
                                        <div class="col w45">
                                            <?=escHtml($candidate->name)?>
                                        </div>
                                        <div class="col w45">
                                            <?=escHtml($candidate->type)?>
                                        </div>
                                        <div class="col w10">
                                            <div class="buttons action-buttons">
                                                <a href="/manage/survey/<?=escHtmlAttr($surveyId)?>/candidates/edit/<?=escHtml($candidate->id)?>/" class="button is-small is-rounded">
                                                    <i class="far fa-edit"></i>
                                                </a>
                                                <a href="/manage/survey/<?=escHtmlAttr($surveyId)?>/candidates/delete/<?=escHtml($candidate->id)?>/" class="button is-small is-rounded delete-button">
