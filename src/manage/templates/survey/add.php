...
<div class="right-layout">
    ...
    <div class="main-screen">
        <div class="main-content">
            <form name="add_survey" action="/manage/add/" method="POST">
                    ...
                    <div class="panel-content">
                        ...
                        <div class="material field">
                            ...
                            <label for="is_active" class="label checkbox-label">
                                Aktif
                                <input type="checkbox" name="is_active" id="is_active" value="1" class="checkbox" checked>
                        ...
                        <div class="material field w25">
                            <div class="control">
                                <input type="number" id="target" name="target" class="input"
